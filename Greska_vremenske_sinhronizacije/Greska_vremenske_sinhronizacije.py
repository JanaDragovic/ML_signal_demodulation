...
# (1) Slucaj originalne konstelacije QPSK simbola - analiza sa greskom vremenske sinhronizacije 
# (1) Prvi način obrade


# Ucitavanje podataka
data_for_ml = scipy.io.loadmat('DataForML_Vrem_Sinh.mat')
data_classic_decision = scipy.io.loadmat('Data_Klasicno_odlucivanje_Vrem_Sinh.mat')
data_pes = scipy.io.loadmat('DataPes_Vrem_Sinh.mat')
