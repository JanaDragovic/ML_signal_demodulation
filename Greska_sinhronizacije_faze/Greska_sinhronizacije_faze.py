...
# (1) Slucaj originalne konstelacije QPSK simbola - analiza sa greskom sinhronizacije faze
# (1) Prvi način obrade


# Ucitavanje podataka
data_for_ml = scipy.io.loadmat('DataForML_Sinh_Faze.mat')
data_classic_decision = scipy.io.loadmat('Data_Klasicno_odlucivanje_Sinh_Faze.mat')
data_pes = scipy.io.loadmat('DataPes_Sinh_Faze.mat')
